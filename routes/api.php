...
Route::prefix('v1')->group(function () {
    ...
    Route::controller(\App\Http\Controllers\Posting\PostingController::class)
        ...
        ->group(function () {
            ...
            Route::delete('posting-information/{id}', 'destroy')->name('posting-information.destroy');
    ...
    Route::controller(\App\Http\Controllers\Posting\PostingMessageTemplateController::class)
        ...
        ->group(function () {
            ...
            Route::post('message-template', 'store')->name('message-template.store');
            Route::put('message-template/{messageTemplate}', 'update')->name('message-template.update');
        });
